...
function Login(props) {
  ...
  if (props.isExpired === null || !props.isAuthorized) {
    button = <button onClick={props.onClick} className="bg-orange px-4 py-1 text-sm sm:text-base rounded hover:bg-sky-300 active:bg-violet-400">
      <span className="inline-flex justify-between gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
        ...
        {/* <span className="invisible sm:visible">Authorize spotify</span> */}
      </span>
    </button>
  }
